...
class Player:
    ...
    def navigate(self, adjacent_room_name):
        self.current_room = self.current_room.adjacents[adjacent_room_name]
...
test_room1 = Room(2,"test room","this is a test room")
